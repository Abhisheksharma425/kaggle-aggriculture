...
def agent(obs):
    ...
    if day < 19:
        # PHASE 1 & 2: Premium Crops (Strawberries & Melons)
        target_straw_total = int(available_slots * 0.7)
        target_melon_total = int(available_slots * 0.3)
        ...
        # If we can't afford premium, backfill with wheat to not waste space
    ...
    if day <= 28:
        # Hire massive amounts if we have cash flowing
        max_hire_cost = 21 if day >= 10 else 13
